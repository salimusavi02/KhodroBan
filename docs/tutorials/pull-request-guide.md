...
این راهنمای عملی برای استفاده از Pull Request (PR) در پروژه OilChenger است. این راهنما به شما کمک می‌کند تا به عنوان یک Solo Developer از PR برای مدیریت بهتر کد استفاده کنید.
...
**آخرین به‌روزرسانی**: این راهنما برای استفاده با repository `alamalhoda/KhodroBan` نوشته شده است.
